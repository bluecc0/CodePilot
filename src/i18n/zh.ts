...
const zh: Record<TranslationKey, string> = {
  ...
  'chatList.cleanupEmptyDialogTitle': '删除空白对话？',
  'chatList.cleanupEmptyDialogDescription': '将删除 {count} 个空白的“New Chat”对话。只包含完全没有消息的对话，且操作无法撤销。',
  'chatList.cleanupEmptyConfirm': '删除空白对话',
  'chatList.cleanupEmptyDeleting': '正在删除…',
  'chatList.cleanupEmptyNone': '没有需要清理的空白“New Chat”对话。',
