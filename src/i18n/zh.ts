...
const zh: Record<TranslationKey, string> = {
  ...
  'chatList.regenerateTitle': 'AI 重新生成标题',
  'chatList.regeneratingTitle': 'AI 正在生成标题…',
  'chatList.titleRegenerated': 'AI 已重新生成标题',
  'chatList.titleRegenerateFailed': 'AI 标题生成失败，请检查供应商配置后重试',
  ...
  'chatList.cleanupEmpty': '清理空白对话',
  'chatList.cleanupEmptyChecking': '正在检查空白对话…',
  'chatList.cleanupEmptyDialogTitle': '清理“{project}”中的空白对话？',
  'chatList.cleanupEmptyDialogDescription': '将删除该项目中的 {count} 个空白“New Chat”对话。只包含完全没有消息的对话，且操作无法撤销。',
  'chatList.cleanupEmptyConfirm': '删除空白对话',
  'chatList.cleanupEmptyDeleting': '正在删除…',
  'chatList.cleanupEmptyNone': '这个项目里没有需要清理的空白“New Chat”对话。',
  'chatList.cleanupEmptySuccess': '已删除 {count} 个空白对话。',
  'chatList.cleanupEmptyFailed': '清理空白对话失败。',
  'chatList.newAssistantConversation': '选择助理并新建对话',
  'chatList.assistantPickerTitle': '新建助理对话',
  'chatList.assistantPickerDescription': '选择默认助理，或使用已导入和自建的角色卡。',
  'chatList.assistantPickerDefaultBadge': '默认',
  'chatList.assistantPickerDefaultDescription': '使用助理工作区的记忆与偏好设定',
  'chatList.assistantPickerCharacters': '自定义角色',
  'chatList.assistantPickerNoCharacters': '还没有自定义角色，可前往角色设置导入或新建。',
  'chatList.assistantPickerCharacterFallback': '自定义角色',
  'chatList.assistantPickerManage': '管理角色',
  'chatList.assistantPickerLoadFailed': '无法加载角色库。',
  'chatList.assistantCreateFailed': '无法创建助理对话。',
  ...
  'settings.wallpaper': '工作区壁纸',
  'settings.wallpaperDesc': '在整个界面后方添加本地图片，文件只保存在这台设备上。',
  'settings.wallpaperUpload': '上传壁纸',
  'settings.wallpaperWorking': '处理中…',
  'settings.wallpaperRemove': '移除',
  'settings.wallpaperOpacity': '壁纸不透明度',
  'settings.wallpaperOpacityDesc': '调整壁纸透过磨砂界面的显示强度。',
  'settings.wallpaperFormats': '支持 PNG、JPEG、WebP，最大 15 MB',
  'settings.wallpaperPreview': '壁纸预览',
  'settings.wallpaperUploadFailed': '壁纸上传失败',
  'settings.wallpaperRemoveFailed': '壁纸移除失败',
  'privacy.enter': '隐私模式',
  'privacy.exit': '退出隐私模式',
  'privacy.title': '临时对话',
  'privacy.description': '进入一个全新的对话空间，不显示已保存的聊天记录。退出隐私模式后，这里的消息会被删除。',
  'privacy.temporaryHint': '临时对话 · 退出后不保存',
  'privacy.restore': '退出隐私模式',
  'privacy.escapeHint': '按 Esc 退出并丢弃本次对话',
  'characters.selectorLabel': '对话角色',
  'characters.defaultAssistant': '默认助理',
