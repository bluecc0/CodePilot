...
const en = {
  ...
  'chatList.cleanupEmptyDialogTitle': 'Delete empty conversations?',
  'chatList.cleanupEmptyDialogDescription': 'Delete {count} empty “New Chat” conversations? Only conversations with no messages are included. This cannot be undone.',
  'chatList.cleanupEmptyConfirm': 'Delete empty chats',
  'chatList.cleanupEmptyDeleting': 'Deleting…',
  'chatList.cleanupEmptyNone': 'There are no empty “New Chat” conversations to clean up.',
