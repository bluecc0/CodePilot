...
const en = {
  ...
  'chatList.regenerateTitle': 'Regenerate Title with AI',
  'chatList.regeneratingTitle': 'Generating title…',
  'chatList.titleRegenerated': 'Title regenerated with AI',
  'chatList.titleRegenerateFailed': 'AI could not generate a title. Check the provider and try again.',
  ...
  'chatList.cleanupEmpty': 'Clean Up Empty Chats',
  'chatList.cleanupEmptyChecking': 'Checking empty chats…',
  'chatList.cleanupEmptyDialogTitle': 'Clean up empty chats in “{project}”?',
  'chatList.cleanupEmptyDialogDescription': 'Delete {count} empty “New Chat” conversations in this project? Only conversations with no messages are included. This cannot be undone.',
  'chatList.cleanupEmptyConfirm': 'Delete empty chats',
  'chatList.cleanupEmptyDeleting': 'Deleting…',
  'chatList.cleanupEmptyNone': 'There are no empty “New Chat” conversations to clean up in this project.',
  'chatList.cleanupEmptySuccess': 'Deleted {count} empty conversations.',
  'chatList.cleanupEmptyFailed': 'Could not clean up empty conversations.',
  'chatList.newAssistantConversation': 'Choose an assistant for a new conversation',
  'chatList.assistantPickerTitle': 'Start an assistant conversation',
  'chatList.assistantPickerDescription': 'Choose the default assistant or one of your character cards.',
  'chatList.assistantPickerDefaultBadge': 'Default',
  'chatList.assistantPickerDefaultDescription': 'Uses your assistant workspace, memory, and preferences',
  'chatList.assistantPickerCharacters': 'Characters',
  'chatList.assistantPickerNoCharacters': 'No custom characters yet. You can import or create one in Character settings.',
  'chatList.assistantPickerCharacterFallback': 'Custom character',
  'chatList.assistantPickerManage': 'Manage characters',
  'chatList.assistantPickerLoadFailed': 'Could not load the character library.',
  'chatList.assistantCreateFailed': 'Could not create the assistant conversation.',
  ...
  'settings.wallpaper': 'Workspace wallpaper',
  'settings.wallpaperDesc': 'Add a local image behind the interface. The file stays on this device.',
  'settings.wallpaperUpload': 'Upload wallpaper',
  'settings.wallpaperWorking': 'Working…',
  'settings.wallpaperRemove': 'Remove',
  'settings.wallpaperOpacity': 'Wallpaper opacity',
  'settings.wallpaperOpacityDesc': 'Adjust how strongly the wallpaper shows through the frosted interface.',
  'settings.wallpaperFormats': 'PNG, JPEG, or WebP · up to 15 MB',
  'settings.wallpaperPreview': 'Wallpaper preview',
  'settings.wallpaperUploadFailed': 'Failed to upload wallpaper',
  'settings.wallpaperRemoveFailed': 'Failed to remove wallpaper',
  'privacy.enter': 'Privacy mode',
  'privacy.exit': 'Exit privacy mode',
  'privacy.title': 'Temporary conversation',
  'privacy.description': 'Start a clean conversation without showing your saved chats. Messages in this space are removed when you exit privacy mode.',
  'privacy.temporaryHint': 'Temporary chat · deleted on exit',
  'privacy.restore': 'Exit privacy mode',
  'privacy.escapeHint': 'Press Esc to exit and discard this conversation',
  'characters.selectorLabel': 'Conversation character',
  'characters.defaultAssistant': 'Default assistant',
  ...
  'settings.characters': 'Characters & Groups',
